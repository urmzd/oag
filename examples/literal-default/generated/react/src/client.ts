...
/** API client for Literal Default API. */
export class ApiClient {
  ...
  async createMessage(body: Message, options?: RequestOptions): Promise<Message> {
    const path = "/messages";
  ...
  async createMessageRaw(body: Message, options?: RequestOptions): Promise<ApiResponse<Message>> {
    const path = "/messages";
    return this.rawRequest<Message>("POST", path, {
      body,
      contentType: "application/json",
      ...options,
    });
  ...
  async getMessageRaw(id: string, options?: RequestOptions): Promise<ApiResponse<Message>> {
    let path = "/messages/{id}";
    path = path.replace("{id}", encodeURIComponent(String(id)));
    return this.rawRequest<Message>("GET", path, {
      ...options,
    });
  }
}
