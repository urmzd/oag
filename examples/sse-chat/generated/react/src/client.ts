...
export class ApiClient {
  ...
  async *createChatCompletionStream(
    ...
    options?: SSEOptions,
  ): AsyncGenerator<SSEEvent<CreateChatCompletionStreamEvent>> {
  ...
  /** Creates a completion for the chat messages. Supports both JSON and streaming responses. (JSON response) */
  ...
  async submitFeedbackRaw(
    ...
    const path = "/chat/feedback";
    return this.rawRequest<void>("POST", path, {
      body,
      contentType: "application/json",
      ...options,
    });
