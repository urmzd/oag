...
import { type SSEEvent, type SSEOptions, streamSse } from "./sse.js";
import type {
  CountTokensRequest,
  CountTokensResponse,
...
export class ApiClient {
  ...
  async *createMessageStream(
    ...
    options?: SSEOptions,
  ): AsyncGenerator<SSEEvent<CreateMessageStreamEvent>> {
  ...
  /** Send a structured message and receive a response. Supports both JSON and SSE streaming. (JSON response) */
  async createMessage(
    anthropicVersion: string,
    body: CreateMessageRequest,
    options?: RequestOptions,
  ...
  async listModels(
    ...
    if (afterId !== undefined && afterId !== null) _q.set("after_id", String(afterId));
    if (beforeId !== undefined && beforeId !== null) _q.set("before_id", String(beforeId));
